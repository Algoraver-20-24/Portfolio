...
const Experience = () => {
...

  {
    ...
    description: [
      'Worked on the DataMAx Data Quality Deployment project for enterprise data quality management.',
      'Developed and validated SQL-based Data Quality checks using Snowflake and Databricks.',
      'Performed metadata analysis, data validation, and supported ETL/Data Engineering workflows.',
      
    ],
    certificateLink: 'https://drive.google.com/file/d/1Af6MSCVfgWNx6dZdBFvwogMQiSeqjTns/view?usp=sharing'
  }
];
...
>
  ...
  >
    ...
    <motion.a
      href={experiences[0].certificateLink}
      target="_blank"
      ...
      className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 text-sm"
    >
...
>
  ...
  <motion.div
    ...
    className="bg-gradient-to-br from-orange-50 to-pink-50 dark:from-gray-800 dark:to-gray-700 backdrop-blur-sm p-6 rounded-2xl shadow-[0_8px_25px_rgba(59,130,246,0.15)] border border-orange-200 dark:border-orange-800 group hover:shadow-[0_20px_40px_rgba(59,130,246,0.4)] hover:border-orange-400 dark:hover:border-orange-600 transition-all duration-500 mb-8"
  >
    <div className="flex justify-between items-start mb-4">
      <div>
        <h4 className="text-xl font-semibold text-gray-900 dark:text-white">
    ...
    <motion.a
      href={experiences[1].certificateLink}
      target="_blank"
      rel="noopener noreferrer"
